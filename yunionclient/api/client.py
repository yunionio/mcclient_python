...
from yunionclient.api import actions
...
from yunionclient.api import contact-groups
from yunionclient.api import contacts
from yunionclient.api import credentials
...
from yunionclient.api import scope-resource
...
from yunionclient.api import servers
from yunionclient.api import servertemplates
from yunionclient.api import service-registries
...
class Client(http.HTTPClient):
    ...
    def __init__(self, auth_url, username, password, domain_name,
        ...
        self.contact-groups = contact-groups.Contact-groupManager(self)
        ...
        self.scope-resource = scope-resource.Scope-resourceManager(self)
        ...
        self.service-registries = service-registries.Service-registryManager(self)
