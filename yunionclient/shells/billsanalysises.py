...
def do_billsanalysis_list(client, args):
    """ List all billsanalysises"""
    page_info = utils.get_paging_info(args)
    billsanalysises = client.billsanalysises.list(**page_info)
    utils.print_list(billsanalysises, client.billsanalysises.columns)