...
def do_inter_vpc_network_route_set_list(client, args):
    """ List all InterVpcNetworkRouteSet """
    page_info = utils.get_paging_info(args)
    intervpcnetworkroutesets = client.intervpcnetworkroutesets.list(**page_info)
    utils.print_list(intervpcnetworkroutesets, client.intervpcnetworkroutesets.columns)