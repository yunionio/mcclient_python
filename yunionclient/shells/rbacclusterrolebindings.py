...
def do_rbacclusterrolebinding_list(client, args):
    """ List all Rbacclusterrolebinding """
    page_info = utils.get_paging_info(args)
    rbacclusterrolebindings = client.rbacclusterrolebindings.list(**page_info)
    utils.print_list(rbacclusterrolebindings, client.rbacclusterrolebindings.columns)