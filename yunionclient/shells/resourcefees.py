...
def do_resource_fee_list(client, args):
    """ List all resourcefees"""
    page_info = utils.get_paging_info(args)
    resourcefees = client.resourcefees.list(**page_info)
    utils.print_list(resourcefees, client.resourcefees.columns)