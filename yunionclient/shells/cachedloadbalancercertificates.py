...
def do_cachedloadbalancercertificate_list(client, args):
    """ List all Cachedloadbalancercertificate """
    page_info = utils.get_paging_info(args)
    cachedloadbalancercertificates = client.cachedloadbalancercertificates.list(**page_info)
    utils.print_list(cachedloadbalancercertificates, client.cachedloadbalancercertificates.columns)