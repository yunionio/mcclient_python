...
def do_federatedclusterrole_list(client, args):
    """ List all Federatedclusterrole """
    page_info = utils.get_paging_info(args)
    federatedclusterroles = client.federatedclusterroles.list(**page_info)
    utils.print_list(federatedclusterroles, client.federatedclusterroles.columns)