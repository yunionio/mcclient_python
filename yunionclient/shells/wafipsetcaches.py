...
def do_waf_ipset_cache_list(client, args):
    """ List all WafIpsetCache """
    page_info = utils.get_paging_info(args)
    wafipsetcaches = client.wafipsetcaches.list(**page_info)
    utils.print_list(wafipsetcaches, client.wafipsetcaches.columns)