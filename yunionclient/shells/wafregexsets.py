...
def do_waf_regexset_list(client, args):
    """ List all WafRegexset """
    page_info = utils.get_paging_info(args)
    wafregexsets = client.wafregexsets.list(**page_info)
    utils.print_list(wafregexsets, client.wafregexsets.columns)