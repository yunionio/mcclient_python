...
def do_cachedloadbalanceracl_list(client, args):
    """ List all Cachedloadbalanceracl """
    page_info = utils.get_paging_info(args)
    cachedloadbalanceracls = client.cachedloadbalanceracls.list(**page_info)
    utils.print_list(cachedloadbalanceracls, client.cachedloadbalanceracls.columns)