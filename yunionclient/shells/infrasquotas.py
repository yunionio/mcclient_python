...
def do_infras_quota_list(client, args):
    """ List all InfrasQuota """
    page_info = utils.get_paging_info(args)
    infrasquotas = client.infrasquotas.list(**page_info)
    utils.print_list(infrasquotas, client.infrasquotas.columns)