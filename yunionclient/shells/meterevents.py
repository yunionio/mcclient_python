...
def do_meter_event_list(client, args):
    """ List all meterevents"""
    page_info = utils.get_paging_info(args)
    meterevents = client.meterevents.list(**page_info)
    utils.print_list(meterevents, client.meterevents.columns)