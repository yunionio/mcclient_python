...
def do_ext_resource_list(client, args):
    """ List all extresources"""
    page_info = utils.get_paging_info(args)
    extresources = client.extresources.list(**page_info)
    utils.print_list(extresources, client.extresources.columns)