...
def do_devtool_cronjob_list(client, args):
    """ List all DevtoolCronjob """
    page_info = utils.get_paging_info(args)
    devtoolcronjobs = client.devtoolcronjobs.list(**page_info)
    utils.print_list(devtoolcronjobs, client.devtoolcronjobs.columns)