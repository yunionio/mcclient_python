...
def do_snapshotpolicy_list(client, args):
    """ List all Snapshotpolicy """
    page_info = utils.get_paging_info(args)
    snapshotpolicies = client.snapshotpolicies.list(**page_info)
    utils.print_list(snapshotpolicies, client.snapshotpolicies.columns)