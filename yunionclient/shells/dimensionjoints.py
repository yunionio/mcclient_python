...
def do_dimensionjoint_list(client, args):
    """ List all dimensionjoints"""
    page_info = utils.get_paging_info(args)
    dimensionjoints = client.dimensionjoints.list(**page_info)
    utils.print_list(dimensionjoints, client.dimensionjoints.columns)