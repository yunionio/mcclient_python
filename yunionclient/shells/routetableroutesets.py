...
def do_route_table_route_set_list(client, args):
    """ List all RouteTableRouteSet """
    page_info = utils.get_paging_info(args)
    routetableroutesets = client.routetableroutesets.list(**page_info)
    utils.print_list(routetableroutesets, client.routetableroutesets.columns)