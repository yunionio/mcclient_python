...
def do_bill_cloudcheck_list(client, args):
    """ List all billcloudchecks"""
    page_info = utils.get_paging_info(args)
    billcloudchecks = client.billcloudchecks.list(**page_info)
    utils.print_list(billcloudchecks, client.billcloudchecks.columns)