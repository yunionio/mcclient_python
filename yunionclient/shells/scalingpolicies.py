...
def do_scalingpolicy_list(client, args):
    """ List all Scalingpolicy """
    page_info = utils.get_paging_info(args)
    scalingpolicies = client.scalingpolicies.list(**page_info)
    utils.print_list(scalingpolicies, client.scalingpolicies.columns)