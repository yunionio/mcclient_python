...
def do_scriptapplyrecord_list(client, args):
    """ List all Scriptapplyrecord """
    page_info = utils.get_paging_info(args)
    scriptapplyrecords = client.scriptapplyrecords.list(**page_info)
    utils.print_list(scriptapplyrecords, client.scriptapplyrecords.columns)