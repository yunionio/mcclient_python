...
def do_ext_attribute_list(client, args):
    """ List all extattributes"""
    page_info = utils.get_paging_info(args)
    extattributes = client.extattributes.list(**page_info)
    utils.print_list(extattributes, client.extattributes.columns)