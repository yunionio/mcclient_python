...
def do_alertresource_list(client, args):
    """ List all Alertresource """
    page_info = utils.get_paging_info(args)
    alertresources = client.alertresources.list(**page_info)
    utils.print_list(alertresources, client.alertresources.columns)