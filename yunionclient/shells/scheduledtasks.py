...
def do_scheduledtask_list(client, args):
    """ List all Scheduledtask """
    page_info = utils.get_paging_info(args)
    scheduledtasks = client.scheduledtasks.list(**page_info)
    utils.print_list(scheduledtasks, client.scheduledtasks.columns)