...
def do_cost_conversion_list(client, args):
    """ List all costconversions"""
    page_info = utils.get_paging_info(args)
    costconversions = client.costconversions.list(**page_info)
    utils.print_list(costconversions, client.costconversions.columns)