...
def do_loadbalanceracl_list(client, args):
    """ List all Loadbalanceracl """
    page_info = utils.get_paging_info(args)
    loadbalanceracls = client.loadbalanceracls.list(**page_info)
    utils.print_list(loadbalanceracls, client.loadbalanceracls.columns)