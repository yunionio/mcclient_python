...
def do_bill_resource_list(client, args):
    """ List all billresources"""
    page_info = utils.get_paging_info(args)
    billresources = client.billresources.list(**page_info)
    utils.print_list(billresources, client.billresources.columns)