...
def do_waf_rule_group_list(client, args):
    """ List all WafRuleGroup """
    page_info = utils.get_paging_info(args)
    wafrulegroups = client.wafrulegroups.list(**page_info)
    utils.print_list(wafrulegroups, client.wafrulegroups.columns)