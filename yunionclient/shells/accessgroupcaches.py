...
def do_access_group_cache_list(client, args):
    """ List all access group caches """
    page_info = utils.get_paging_info(args)
    caches = client.accessgroupcaches.list(**page_info)
    utils.print_list(caches, client.accessgroupcaches.columns)
