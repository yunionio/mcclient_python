...
def do_tablestore_list(client, args):
    """ List all tablestores"""
    page_info = utils.get_paging_info(args)
    tablestores = client.tablestores.list(**page_info)
    utils.print_list(tablestores, client.tablestores.columns)