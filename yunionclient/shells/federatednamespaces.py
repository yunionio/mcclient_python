...
def do_federatednamespace_list(client, args):
    """ List all Federatednamespace """
    page_info = utils.get_paging_info(args)
    federatednamespaces = client.federatednamespaces.list(**page_info)
    utils.print_list(federatednamespaces, client.federatednamespaces.columns)