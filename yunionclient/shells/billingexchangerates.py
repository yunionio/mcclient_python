...
def do_billing_exchange_rate_list(client, args):
    """ List all billingexchangerates"""
    page_info = utils.get_paging_info(args)
    billingexchangerates = client.billingexchangerates.list(**page_info)
    utils.print_list(billingexchangerates, client.billingexchangerates.columns)