...
def do_serviceaccount_list(client, args):
    """ List all Serviceaccount """
    page_info = utils.get_paging_info(args)
    serviceaccounts = client.serviceaccounts.list(**page_info)
    utils.print_list(serviceaccounts, client.serviceaccounts.columns)