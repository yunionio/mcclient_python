...
def do_dbinstanceaccount_list(client, args):
    """ List all Dbinstanceaccount """
    page_info = utils.get_paging_info(args)
    dbinstanceaccounts = client.dbinstanceaccounts.list(**page_info)
    utils.print_list(dbinstanceaccounts, client.dbinstanceaccounts.columns)