...
def do_bill_analysis_list(client, args):
    """ List all billanalysises"""
    page_info = utils.get_paging_info(args)
    billanalysises = client.billanalysises.list(**page_info)
    utils.print_list(billanalysises, client.billanalysises.columns)