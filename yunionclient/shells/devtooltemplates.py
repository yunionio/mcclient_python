...
def do_devtool_template_list(client, args):
    """ List all DevtoolTemplate """
    page_info = utils.get_paging_info(args)
    devtooltemplates = client.devtooltemplates.list(**page_info)
    utils.print_list(devtooltemplates, client.devtooltemplates.columns)