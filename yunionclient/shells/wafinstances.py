...
def do_waf_instance_list(client, args):
    """ List all WafInstance """
    page_info = utils.get_paging_info(args)
    wafinstances = client.wafinstances.list(**page_info)
    utils.print_list(wafinstances, client.wafinstances.columns)