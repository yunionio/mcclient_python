...
def do_loadbalancerlistener_list(client, args):
    """ List all Loadbalancerlistener """
    page_info = utils.get_paging_info(args)
    loadbalancerlisteners = client.loadbalancerlisteners.list(**page_info)
    utils.print_list(loadbalancerlisteners, client.loadbalancerlisteners.columns)