...
def do_policy_definition_list(client, args):
    """ List all PolicyDefinition """
    page_info = utils.get_paging_info(args)
    policydefinitions = client.policydefinitions.list(**page_info)
    utils.print_list(policydefinitions, client.policydefinitions.columns)