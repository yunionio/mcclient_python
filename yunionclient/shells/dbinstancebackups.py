...
def do_dbinstancebackup_list(client, args):
    """ List all Dbinstancebackup """
    page_info = utils.get_paging_info(args)
    dbinstancebackups = client.dbinstancebackups.list(**page_info)
    utils.print_list(dbinstancebackups, client.dbinstancebackups.columns)