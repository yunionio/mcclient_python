...
def do_project_quota_list(client, args):
    """ List all ProjectQuota """
    page_info = utils.get_paging_info(args)
    projectquotas = client.projectquotas.list(**page_info)
    utils.print_list(projectquotas, client.projectquotas.columns)