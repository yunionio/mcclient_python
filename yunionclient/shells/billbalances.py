...
def do_bill_balance_list(client, args):
    """ List all billbalances"""
    page_info = utils.get_paging_info(args)
    billbalances = client.billbalances.list(**page_info)
    utils.print_list(billbalances, client.billbalances.columns)