...
def do_secgrouprule_list(client, args):
    """ List all Secgrouprule """
    page_info = utils.get_paging_info(args)
    secgrouprules = client.secgrouprules.list(**page_info)
    utils.print_list(secgrouprules, client.secgrouprules.columns)