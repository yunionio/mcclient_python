...
def do_rbacclusterrole_list(client, args):
    """ List all Rbacclusterrole """
    page_info = utils.get_paging_info(args)
    rbacclusterroles = client.rbacclusterroles.list(**page_info)
    utils.print_list(rbacclusterroles, client.rbacclusterroles.columns)