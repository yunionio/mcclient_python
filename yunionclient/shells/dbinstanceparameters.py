...
def do_dbinstanceparameter_list(client, args):
    """ List all Dbinstanceparameter """
    page_info = utils.get_paging_info(args)
    dbinstanceparameters = client.dbinstanceparameters.list(**page_info)
    utils.print_list(dbinstanceparameters, client.dbinstanceparameters.columns)