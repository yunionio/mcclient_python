...
def do_email_config_list(client, args):
    """ List all EmailConfig """
    page_info = utils.get_paging_info(args)
    emailconfigs = client.emailconfigs.list(**page_info)
    utils.print_list(emailconfigs, client.emailconfigs.columns)