...
def do_tap_service_list(client, args):
    """ List all tapservices"""
    page_info = utils.get_paging_info(args)
    tapservices = client.tapservices.list(**page_info)
    utils.print_list(tapservices, client.tapservices.columns)