...
def do_sshkeypair_list(client, args):
    """ List all sshkeypairs"""
    page_info = utils.get_paging_info(args)
    sshkeypairs = client.sshkeypairs.list(**page_info)
    utils.print_list(sshkeypairs, client.sshkeypairs.columns)