...
def do_scheudledtaskactivity_list(client, args):
    """ List all Scheudledtaskactivity """
    page_info = utils.get_paging_info(args)
    scheduledtaskactivities = client.scheduledtaskactivities.list(**page_info)
    utils.print_list(scheduledtaskactivities, client.scheduledtaskactivities.columns)