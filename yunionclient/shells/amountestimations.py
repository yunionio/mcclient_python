...
def do_amount_estimation_list(client, args):
    """ List all amountestimations"""
    page_info = utils.get_paging_info(args)
    amountestimations = client.amountestimations.list(**page_info)
    utils.print_list(amountestimations, client.amountestimations.columns)