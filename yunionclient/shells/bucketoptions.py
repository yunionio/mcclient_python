...
def do_bucket_option_list(client, args):
    """ List all bucketoptions"""
    page_info = utils.get_paging_info(args)
    bucketoptions = client.bucketoptions.list(**page_info)
    utils.print_list(bucketoptions, client.bucketoptions.columns)