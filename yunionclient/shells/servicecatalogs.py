...
def do_servicecatalog_list(client, args):
    """ List all Servicecatalog """
    page_info = utils.get_paging_info(args)
    servicecatalogs = client.servicecatalogs.list(**page_info)
    utils.print_list(servicecatalogs, client.servicecatalogs.columns)