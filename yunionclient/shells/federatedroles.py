...
def do_federatedrole_list(client, args):
    """ List all Federatedrole """
    page_info = utils.get_paging_info(args)
    federatedroles = client.federatedroles.list(**page_info)
    utils.print_list(federatedroles, client.federatedroles.columns)