...
def do_scalinggroup_list(client, args):
    """ List all Scalinggroup """
    page_info = utils.get_paging_info(args)
    scalinggroups = client.scalinggroups.list(**page_info)
    utils.print_list(scalinggroups, client.scalinggroups.columns)