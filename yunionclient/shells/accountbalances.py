...
def do_account_balance_list(client, args):
    """ List all accountbalances"""
    page_info = utils.get_paging_info(args)
    accountbalances = client.accountbalances.list(**page_info)
    utils.print_list(accountbalances, client.accountbalances.columns)