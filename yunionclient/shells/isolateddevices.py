...
def do_isolated_device_list(client, args):
    """ List all IsolatedDevice """
    page_info = utils.get_paging_info(args)
    isolateddevices = client.isolateddevices.list(**page_info)
    utils.print_list(isolateddevices, client.isolateddevices.columns)