...
def do_resource_detail_list(client, args):
    """ List all resourcedetails"""
    page_info = utils.get_paging_info(args)
    resourcedetails = client.resourcedetails.list(**page_info)
    utils.print_list(resourcedetails, client.resourcedetails.columns)