...
def do_instance_snapshot_list(client, args):
    """ List all InstanceSnapshot """
    page_info = utils.get_paging_info(args)
    instancesnapshots = client.instancesnapshots.list(**page_info)
    utils.print_list(instancesnapshots, client.instancesnapshots.columns)