...
def do_loadbalanceragent_list(client, args):
    """ List all Loadbalanceragent """
    page_info = utils.get_paging_info(args)
    loadbalanceragents = client.loadbalanceragents.list(**page_info)
    utils.print_list(loadbalanceragents, client.loadbalanceragents.columns)