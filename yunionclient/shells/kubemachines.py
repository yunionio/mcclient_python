...
def do_kubemachine_list(client, args):
    """ List all Kubemachine """
    page_info = utils.get_paging_info(args)
    kubemachines = client.kubemachines.list(**page_info)
    utils.print_list(kubemachines, client.kubemachines.columns)