...
def do_proxysetting_list(client, args):
    """ List all Proxysetting """
    page_info = utils.get_paging_info(args)
    proxysettings = client.proxysettings.list(**page_info)
    utils.print_list(proxysettings, client.proxysettings.columns)