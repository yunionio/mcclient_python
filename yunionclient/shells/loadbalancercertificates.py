...
def do_loadbalancercertificate_list(client, args):
    """ List all Loadbalancercertificate """
    page_info = utils.get_paging_info(args)
    loadbalancercertificates = client.loadbalancercertificates.list(**page_info)
    utils.print_list(loadbalancercertificates, client.loadbalancercertificates.columns)