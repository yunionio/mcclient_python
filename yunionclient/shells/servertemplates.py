...
def do_servertemplate_list(client, args):
    """ List all Servertemplate """
    page_info = utils.get_paging_info(args)
    servertemplates = client.servertemplates.list(**page_info)
    utils.print_list(servertemplates, client.servertemplates.columns)