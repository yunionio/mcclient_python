...
def do_alertrecordshield_list(client, args):
    """ List all Alertrecordshield """
    page_info = utils.get_paging_info(args)
    alertrecordshields = client.alertrecordshields.list(**page_info)
    utils.print_list(alertrecordshields, client.alertrecordshields.columns)