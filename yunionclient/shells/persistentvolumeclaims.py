...
def do_persistentvolumeclaim_list(client, args):
    """ List all Persistentvolumeclaim """
    page_info = utils.get_paging_info(args)
    persistentvolumeclaims = client.persistentvolumeclaims.list(**page_info)
    utils.print_list(persistentvolumeclaims, client.persistentvolumeclaims.columns)