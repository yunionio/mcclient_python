...
def do_unifiedmonitor_list(client, args):
    """ List all Unifiedmonitor """
    page_info = utils.get_paging_info(args)
    unifiedmonitors = client.unifiedmonitors.list(**page_info)
    utils.print_list(unifiedmonitors, client.unifiedmonitors.columns)