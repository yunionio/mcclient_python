...
def do_backupstorage_list(client, args):
    """ List all backupstorages"""
    page_info = utils.get_paging_info(args)
    backupstorages = client.backupstorages.list(**page_info)
    utils.print_list(backupstorages, client.backupstorages.columns)