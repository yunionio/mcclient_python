...
def do_role_assignment_list(client, args):
    """ List all RoleAssignment """
    page_info = utils.get_paging_info(args)
    roleassignments = client.roleassignments.list(**page_info)
    utils.print_list(roleassignments, client.roleassignments.columns)