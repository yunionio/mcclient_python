...
def do_persistentvolume_list(client, args):
    """ List all Persistentvolume """
    page_info = utils.get_paging_info(args)
    persistentvolumes = client.persistentvolumes.list(**page_info)
    utils.print_list(persistentvolumes, client.persistentvolumes.columns)