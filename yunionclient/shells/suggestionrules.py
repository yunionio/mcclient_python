...
def do_suggestion_rule_list(client, args):
    """ List all Suggestionrule """
    page_info = utils.get_paging_info(args)
    suggestionrules = client.suggestionrules.list(**page_info)
    utils.print_list(suggestionrules, client.suggestionrules.columns)