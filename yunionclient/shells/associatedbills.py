...
def do_associated_bill_list(client, args):
    """ List all associatedbills"""
    page_info = utils.get_paging_info(args)
    associatedbills = client.associatedbills.list(**page_info)
    utils.print_list(associatedbills, client.associatedbills.columns)