...
def do_dns_trafficpolicy_list(client, args):
    """ List all DnsTrafficpolicy """
    page_info = utils.get_paging_info(args)
    dnstrafficpolicies = client.dnstrafficpolicies.list(**page_info)
    utils.print_list(dnstrafficpolicies, client.dnstrafficpolicies.columns)