...
def do_scopedpolicy_list(client, args):
    """ List all Scopedpolicy """
    page_info = utils.get_paging_info(args)
    scopedpolicies = client.scopedpolicies.list(**page_info)
    utils.print_list(scopedpolicies, client.scopedpolicies.columns)