...
def do_metricmeasurement_list(client, args):
    """ List all Metricmeasurement """
    page_info = utils.get_paging_info(args)
    metricmeasurements = client.metricmeasurements.list(**page_info)
    utils.print_list(metricmeasurements, client.metricmeasurements.columns)