...
def do_domain_quota_list(client, args):
    """ List all DomainQuota """
    page_info = utils.get_paging_info(args)
    domainquotas = client.domainquotas.list(**page_info)
    utils.print_list(domainquotas, client.domainquotas.columns)