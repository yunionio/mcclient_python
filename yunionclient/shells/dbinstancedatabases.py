...
def do_dbinstancedatabase_list(client, args):
    """ List all Dbinstancedatabase """
    page_info = utils.get_paging_info(args)
    dbinstancedatabases = client.dbinstancedatabases.list(**page_info)
    utils.print_list(dbinstancedatabases, client.dbinstancedatabases.columns)