...
def do_shared_bill_list(client, args):
    """ List all sharedbills"""
    page_info = utils.get_paging_info(args)
    sharedbills = client.sharedbills.list(**page_info)
    utils.print_list(sharedbills, client.sharedbills.columns)