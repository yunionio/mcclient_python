...
def do_scopedpolicybinding_list(client, args):
    """ List all Scopedpolicybinding """
    page_info = utils.get_paging_info(args)
    scopedpolicybindings = client.scopedpolicybindings.list(**page_info)
    utils.print_list(scopedpolicybindings, client.scopedpolicybindings.columns)