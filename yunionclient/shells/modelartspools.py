...
def do_modelarts_pool_list(client, args):
    """ List all modelartspools"""
    page_info = utils.get_paging_info(args)
    modelartspools = client.modelartspools.list(**page_info)
    utils.print_list(modelartspools, client.modelartspools.columns)