...
def do_dbinstance_sku_list(client, args):
    """ List all DbinstanceSku """
    page_info = utils.get_paging_info(args)
    dbinstanceskus = client.dbinstanceskus.list(**page_info)
    utils.print_list(dbinstanceskus, client.dbinstanceskus.columns)