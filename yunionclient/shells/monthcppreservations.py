...
def do_month_cpp_reservation_list(client, args):
    """ List all monthcppreservations"""
    page_info = utils.get_paging_info(args)
    monthcppreservations = client.monthcppreservations.list(**page_info)
    utils.print_list(monthcppreservations, client.monthcppreservations.columns)