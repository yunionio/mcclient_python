...
def do_route_table_association_list(client, args):
    """ List all RouteTableAssociation """
    page_info = utils.get_paging_info(args)
    routetableassociations = client.routetableassociations.list(**page_info)
    utils.print_list(routetableassociations, client.routetableassociations.columns)