...
def do_modelarts_pool_sku_list(client, args):
    """ List all modelartspoolskus"""
    page_info = utils.get_paging_info(args)
    modelartspoolskus = client.modelartspoolskus.list(**page_info)
    utils.print_list(modelartspoolskus, client.modelartspoolskus.columns)