...
def do_suggestion_alert_list(client, args):
    """ List all Suggestionrule """
    page_info = utils.get_paging_info(args)
    suggestionalerts = client.suggestionalerts.list(**page_info)
    utils.print_list(suggestionalerts, client.suggestionalerts.columns)