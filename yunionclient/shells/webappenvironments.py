...
def do_webappenvironment_list(client, args):
    """ List all Webappenvironment """
    page_info = utils.get_paging_info(args)
    webappenvironments = client.webappenvironments.list(**page_info)
    utils.print_list(webappenvironments, client.webappenvironments.columns)