...
def do_bill_detail_list(client, args):
    """ List all billdetails"""
    page_info = utils.get_paging_info(args)
    billdetails = client.billdetails.list(**page_info)
    utils.print_list(billdetails, client.billdetails.columns)