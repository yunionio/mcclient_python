...
def do_policy_assignment_list(client, args):
    """ List all PolicyAssignment """
    page_info = utils.get_paging_info(args)
    policyassignments = client.policyassignments.list(**page_info)
    utils.print_list(policyassignments, client.policyassignments.columns)