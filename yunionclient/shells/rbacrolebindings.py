...
def do_rbacrolebinding_list(client, args):
    """ List all Rbacrolebinding """
    page_info = utils.get_paging_info(args)
    rbacrolebindings = client.rbacrolebindings.list(**page_info)
    utils.print_list(rbacrolebindings, client.rbacrolebindings.columns)