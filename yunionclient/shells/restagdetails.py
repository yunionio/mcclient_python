...
def do_res_tag_detail_list(client, args):
    """ List all restagdetails"""
    page_info = utils.get_paging_info(args)
    restagdetails = client.restagdetails.list(**page_info)
    utils.print_list(restagdetails, client.restagdetails.columns)