...
def do_loadbalancerlistenerrule_list(client, args):
    """ List all Loadbalancerlistenerrule """
    page_info = utils.get_paging_info(args)
    loadbalancerlistenerrules = client.loadbalancerlistenerrules.list(**page_info)
    utils.print_list(loadbalancerlistenerrules, client.loadbalancerlistenerrules.columns)