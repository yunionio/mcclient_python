...
def do_costreport_list(client, args):
    """ List all costreports"""
    page_info = utils.get_paging_info(args)
    costreports = client.costreports.list(**page_info)
    utils.print_list(costreports, client.costreports.columns)