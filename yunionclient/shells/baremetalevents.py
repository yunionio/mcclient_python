...
def do_baremetalevent_list(client, args):
    """ List all Baremetalevent """
    page_info = utils.get_paging_info(args)
    baremetalevents = client.baremetalevents.list(**page_info)
    utils.print_list(baremetalevents, client.baremetalevents.columns)