...
def do_cloud_kube_cluster_list(client, args):
    """ List all CloudKubeCluster """
    page_info = utils.get_paging_info(args)
    cloudkubeclusters = client.cloudkubeclusters.list(**page_info)
    utils.print_list(cloudkubeclusters, client.cloudkubeclusters.columns)