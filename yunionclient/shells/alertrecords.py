...
def do_alertrecord_list(client, args):
    """ List all Alertrecord """
    page_info = utils.get_paging_info(args)
    alertrecords = client.alertrecords.list(**page_info)
    utils.print_list(alertrecords, client.alertrecords.columns)