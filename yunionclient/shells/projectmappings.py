...
def do_project_mapping_list(client, args):
    """ List all ProjectMapping """
    page_info = utils.get_paging_info(args)
    projectmappings = client.projectmappings.list(**page_info)
    utils.print_list(projectmappings, client.projectmappings.columns)