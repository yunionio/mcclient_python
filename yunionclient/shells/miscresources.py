...
def do_misc_resource_list(client, args):
    """ List all miscresources"""
    page_info = utils.get_paging_info(args)
    miscresources = client.miscresources.list(**page_info)
    utils.print_list(miscresources, client.miscresources.columns)