...
def do_notifyconfig_list(client, args):
    """ List all Notifyconfig """
    page_info = utils.get_paging_info(args)
    notifyconfigs = client.notifyconfigs.list(**page_info)
    utils.print_list(notifyconfigs, client.notifyconfigs.columns)