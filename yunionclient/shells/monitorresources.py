...
def do_monitorresource_list(client, args):
    """ List all Monitorresource """
    page_info = utils.get_paging_info(args)
    monitorresources = client.monitorresources.list(**page_info)
    utils.print_list(monitorresources, client.monitorresources.columns)