...
def do_storagecache_list(client, args):
    """ List all Storagecache """
    page_info = utils.get_paging_info(args)
    storagecaches = client.storagecaches.list(**page_info)
    utils.print_list(storagecaches, client.storagecaches.columns)