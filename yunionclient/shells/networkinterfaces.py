...
def do_networkinterface_list(client, args):
    """ List all Networkinterface """
    page_info = utils.get_paging_info(args)
    networkinterfaces = client.networkinterfaces.list(**page_info)
    utils.print_list(networkinterfaces, client.networkinterfaces.columns)