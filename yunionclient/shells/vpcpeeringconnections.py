...
def do_vpc_peering_connection_list(client, args):
    """ List all VpcPeeringConnection """
    page_info = utils.get_paging_info(args)
    vpcpeeringconnections = client.vpcpeeringconnections.list(**page_info)
    utils.print_list(vpcpeeringconnections, client.vpcpeeringconnections.columns)