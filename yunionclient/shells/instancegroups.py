...
def do_instancegroup_list(client, args):
    """ List all Instancegroup """
    page_info = utils.get_paging_info(args)
    instancegroups = client.instancegroups.list(**page_info)
    utils.print_list(instancegroups, client.instancegroups.columns)