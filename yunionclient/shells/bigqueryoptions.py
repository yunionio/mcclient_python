...
def do_bigquery_option_list(client, args):
    """ List all bigqueryoptions"""
    page_info = utils.get_paging_info(args)
    bigqueryoptions = client.bigqueryoptions.list(**page_info)
    utils.print_list(bigqueryoptions, client.bigqueryoptions.columns)