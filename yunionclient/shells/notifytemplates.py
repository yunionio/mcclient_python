...
def do_notifytemplate_list(client, args):
    """ List all Notifytemplate """
    page_info = utils.get_paging_info(args)
    notifytemplates = client.notifytemplates.list(**page_info)
    utils.print_list(notifytemplates, client.notifytemplates.columns)