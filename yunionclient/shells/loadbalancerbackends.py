...
def do_loadbalancerbackend_list(client, args):
    """ List all Loadbalancerbackend """
    page_info = utils.get_paging_info(args)
    loadbalancerbackends = client.loadbalancerbackends.list(**page_info)
    utils.print_list(loadbalancerbackends, client.loadbalancerbackends.columns)