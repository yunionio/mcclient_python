...
def do_loadbalancerbackendgroup_list(client, args):
    """ List all Loadbalancerbackendgroup """
    page_info = utils.get_paging_info(args)
    loadbalancerbackendgroups = client.loadbalancerbackendgroups.list(**page_info)
    utils.print_list(loadbalancerbackendgroups, client.loadbalancerbackendgroups.columns)