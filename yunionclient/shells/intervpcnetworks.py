...
def do_inter_vpc_network_list(client, args):
    """ List all InterVpcNetwork """
    page_info = utils.get_paging_info(args)
    intervpcnetworks = client.intervpcnetworks.list(**page_info)
    utils.print_list(intervpcnetworks, client.intervpcnetworks.columns)