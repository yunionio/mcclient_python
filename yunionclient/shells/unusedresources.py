...
def do_unused_resource_list(client, args):
    """ List all unusedresources"""
    page_info = utils.get_paging_info(args)
    unusedresources = client.unusedresources.list(**page_info)
    utils.print_list(unusedresources, client.unusedresources.columns)