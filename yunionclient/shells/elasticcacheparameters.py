...
def do_elasticcacheparameter_list(client, args):
    """ List all Elasticcacheparameter """
    page_info = utils.get_paging_info(args)
    elasticcacheparameters = client.elasticcacheparameters.list(**page_info)
    utils.print_list(elasticcacheparameters, client.elasticcacheparameters.columns)