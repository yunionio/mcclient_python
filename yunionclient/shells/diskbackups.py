...
def do_diskbackup_list(client, args):
    """ List all diskbackups"""
    page_info = utils.get_paging_info(args)
    diskbackups = client.diskbackups.list(**page_info)
    utils.print_list(diskbackups, client.diskbackups.columns)