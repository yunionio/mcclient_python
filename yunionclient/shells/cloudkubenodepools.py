...
def do_cloud_kube_node_pool_list(client, args):
    """ List all CloudKubeNodePool """
    page_info = utils.get_paging_info(args)
    cloudkubenodepools = client.cloudkubenodepools.list(**page_info)
    utils.print_list(cloudkubenodepools, client.cloudkubenodepools.columns)