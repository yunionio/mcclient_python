...
def do_bill_condition_list(client, args):
    """ List all billconditions"""
    page_info = utils.get_paging_info(args)
    billconditions = client.billconditions.list(**page_info)
    utils.print_list(billconditions, client.billconditions.columns)