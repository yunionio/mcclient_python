...
def do_alert_notification_list(client, args):
    """ List all AlertNotification """
    page_info = utils.get_paging_info(args)
    alertnotifications = client.alertnotifications.list(**page_info)
    utils.print_list(alertnotifications, client.alertnotifications.columns)