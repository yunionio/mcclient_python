...
def do_cloudproviderregion_list(client, args):
    """ List all Cloudproviderregion """
    page_info = utils.get_paging_info(args)
    cloudproviderregions = client.cloudproviderregions.list(**page_info)
    utils.print_list(cloudproviderregions, client.cloudproviderregions.columns)
