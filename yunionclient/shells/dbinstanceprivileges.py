...
def do_dbinstanceprivilege_list(client, args):
    """ List all Dbinstanceprivilege """
    page_info = utils.get_paging_info(args)
    dbinstanceprivileges = client.dbinstanceprivileges.list(**page_info)
    utils.print_list(dbinstanceprivileges, client.dbinstanceprivileges.columns)