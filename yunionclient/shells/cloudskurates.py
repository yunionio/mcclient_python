...
def do_cloud_sku_rate_list(client, args):
    """ List all cloudskurates"""
    page_info = utils.get_paging_info(args)
    cloudskurates = client.cloudskurates.list(**page_info)
    utils.print_list(cloudskurates, client.cloudskurates.columns)