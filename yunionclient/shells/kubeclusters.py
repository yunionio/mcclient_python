...
def do_kubecluster_list(client, args):
    """ List all Kubecluster """
    page_info = utils.get_paging_info(args)
    kubeclusters = client.kubeclusters.list(**page_info)
    utils.print_list(kubeclusters, client.kubeclusters.columns)