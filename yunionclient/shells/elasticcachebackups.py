...
def do_elasticcachebackup_list(client, args):
    """ List all Elasticcachebackup """
    page_info = utils.get_paging_info(args)
    elasticcachebackups = client.elasticcachebackups.list(**page_info)
    utils.print_list(elasticcachebackups, client.elasticcachebackups.columns)