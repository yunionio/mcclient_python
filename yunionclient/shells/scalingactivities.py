...
def do_scalingactivity_list(client, args):
    """ List all Scalingactivity """
    page_info = utils.get_paging_info(args)
    scalingactivities = client.scalingactivities.list(**page_info)
    utils.print_list(scalingactivities, client.scalingactivities.columns)