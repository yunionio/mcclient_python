...
def do_cloudproviderquota_list(client, args):
    """ List all Cloudproviderquota """
    page_info = utils.get_paging_info(args)
    cloudproviderquotas = client.cloudproviderquotas.list(**page_info)
    utils.print_list(cloudproviderquotas, client.cloudproviderquotas.columns)