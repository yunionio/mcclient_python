...
def do_dynamicschedtag_list(client, args):
    """ List all dynamicschedtags"""
    page_info = utils.get_paging_info(args)
    dynamicschedtags = client.dynamicschedtags.list(**page_info)
    utils.print_list(dynamicschedtags, client.dynamicschedtags.columns)