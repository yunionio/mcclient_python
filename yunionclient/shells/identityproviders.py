...
def do_identity_provider_list(client, args):
    """ List all IdentityProvider """
    page_info = utils.get_paging_info(args)
    identityproviders = client.identityproviders.list(**page_info)
    utils.print_list(identityproviders, client.identityproviders.columns)