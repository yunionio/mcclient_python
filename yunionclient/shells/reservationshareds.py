...
def do_reservation_shared_list(client, args):
    """ List all reservationshareds"""
    page_info = utils.get_paging_info(args)
    reservationshareds = client.reservationshareds.list(**page_info)
    utils.print_list(reservationshareds, client.reservationshareds.columns)