...
def do_waf_regexset_cache_list(client, args):
    """ List all WafRegexsetCache """
    page_info = utils.get_paging_info(args)
    wafregexsetcaches = client.wafregexsetcaches.list(**page_info)
    utils.print_list(wafregexsetcaches, client.wafregexsetcaches.columns)