...
def do_billsdimensionsanalysis_list(client, args):
    """ List all billsdimensionsanalysis"""
    page_info = utils.get_paging_info(args)
    billsdimensionsanalysis = client.billsdimensionsanalysis.list(**page_info)
    utils.print_list(billsdimensionsanalysis, client.billsdimensionsanalysis.columns)