...
def do_elasticcacheacl_list(client, args):
    """ List all Elasticcacheacl """
    page_info = utils.get_paging_info(args)
    elasticcacheacls = client.elasticcacheacls.list(**page_info)
    utils.print_list(elasticcacheacls, client.elasticcacheacls.columns)