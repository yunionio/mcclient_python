...
def do_loadbalancercluster_list(client, args):
    """ List all Loadbalancercluster """
    page_info = utils.get_paging_info(args)
    loadbalancerclusters = client.loadbalancerclusters.list(**page_info)
    utils.print_list(loadbalancerclusters, client.loadbalancerclusters.columns)