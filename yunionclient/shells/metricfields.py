...
def do_metricfield_list(client, args):
    """ List all Metricfield """
    page_info = utils.get_paging_info(args)
    metricfields = client.metricfields.list(**page_info)
    utils.print_list(metricfields, client.metricfields.columns)