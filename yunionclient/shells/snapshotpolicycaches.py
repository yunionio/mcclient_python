...
def do_snapshotpolicycache_list(client, args):
    """ List all Snapshotpolicycache """
    page_info = utils.get_paging_info(args)
    snapshotpolicycaches = client.snapshotpolicycaches.list(**page_info)
    utils.print_list(snapshotpolicycaches, client.snapshotpolicycaches.columns)