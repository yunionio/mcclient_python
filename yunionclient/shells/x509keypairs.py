...
def do_x509keypair_list(client, args):
    """ List all X509keypair """
    page_info = utils.get_paging_info(args)
    x509keypairs = client.x509keypairs.list(**page_info)
    utils.print_list(x509keypairs, client.x509keypairs.columns)