...
def do_ext_resource_type_list(client, args):
    """ List all extresourcetypes"""
    page_info = utils.get_paging_info(args)
    extresourcetypes = client.extresourcetypes.list(**page_info)
    utils.print_list(extresourcetypes, client.extresourcetypes.columns)