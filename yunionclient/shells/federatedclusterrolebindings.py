...
def do_federatedclusterrolebinding_list(client, args):
    """ List all Federatedclusterrolebinding """
    page_info = utils.get_paging_info(args)
    federatedclusterrolebindings = client.federatedclusterrolebindings.list(**page_info)
    utils.print_list(federatedclusterrolebindings, client.federatedclusterrolebindings.columns)