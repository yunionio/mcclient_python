...
def do_access_group_rule_list(client, args):
    """ List all access group rules """
    page_info = utils.get_paging_info(args)
    rules = client.accessgrouprules.list(**page_info)
    utils.print_list(rules, client.accessgrouprules.columns)
