...
def do_cloud_kube_node_list(client, args):
    """ List all CloudKubeNode """
    page_info = utils.get_paging_info(args)
    cloudkubenodes = client.cloudkubenodes.list(**page_info)
    utils.print_list(cloudkubenodes, client.cloudkubenodes.columns)