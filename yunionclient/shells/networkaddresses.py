...
def do_networkaddress_list(client, args):
    """ List all Networkaddress """
    page_info = utils.get_paging_info(args)
    networkaddresses = client.networkaddresses.list(**page_info)
    utils.print_list(networkaddresses, client.networkaddresses.columns)