...
def do_appfromfile_list(client, args):
    """ List all Appfromfile """
    page_info = utils.get_paging_info(args)
    appfromfiles = client.appfromfiles.list(**page_info)
    utils.print_list(appfromfiles, client.appfromfiles.columns)