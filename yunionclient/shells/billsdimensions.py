...
def do_billsdimension_list(client, args):
    """ List all billsdimensions"""
    page_info = utils.get_paging_info(args)
    billsdimensions = client.billsdimensions.list(**page_info)
    utils.print_list(billsdimensions, client.billsdimensions.columns)