...
def do_schedpolicy_list(client, args):
    """ List all schedpolicies"""
    page_info = utils.get_paging_info(args)
    schedpolicies = client.schedpolicies.list(**page_info)
    utils.print_list(schedpolicies, client.schedpolicies.columns)