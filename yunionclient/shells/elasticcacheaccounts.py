...
def do_elasticcacheaccount_list(client, args):
    """ List all Elasticcacheaccount """
    page_info = utils.get_paging_info(args)
    elasticcacheaccounts = client.elasticcacheaccounts.list(**page_info)
    utils.print_list(elasticcacheaccounts, client.elasticcacheaccounts.columns)