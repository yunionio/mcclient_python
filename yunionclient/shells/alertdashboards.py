...
def do_alertdashboard_list(client, args):
    """ List all Alertdashboard """
    page_info = utils.get_paging_info(args)
    alertdashboards = client.alertdashboards.list(**page_info)
    utils.print_list(alertdashboards, client.alertdashboards.columns)