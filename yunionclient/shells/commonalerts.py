...
def do_commonalert_list(client, args):
    """ List all Commonalert """
    page_info = utils.get_paging_info(args)
    commonalerts = client.commonalerts.list(**page_info)
    utils.print_list(commonalerts, client.commonalerts.columns)