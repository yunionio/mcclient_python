...
def do_ipv6_gateway_list(client, args):
    """ List all ipv6gateways"""
    page_info = utils.get_paging_info(args)
    ipv6gateways = client.ipv6gateways.list(**page_info)
    utils.print_list(ipv6gateways, client.ipv6gateways.columns)