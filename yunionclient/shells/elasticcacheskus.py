...
def do_elasticcachesku_list(client, args):
    """ List all Elasticcachesku """
    page_info = utils.get_paging_info(args)
    elasticcacheskus = client.elasticcacheskus.list(**page_info)
    utils.print_list(elasticcacheskus, client.elasticcacheskus.columns)