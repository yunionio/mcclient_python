...
def do_cloudgroup_list(client, args):
    """ List all cloudgroups"""
    page_info = utils.get_paging_info(args)
    cloudgroups = client.cloudgroups.list(**page_info)
    utils.print_list(cloudgroups, client.cloudgroups.columns)