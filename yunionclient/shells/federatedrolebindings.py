...
def do_federatedrolebinding_list(client, args):
    """ List all Federatedrolebinding """
    page_info = utils.get_paging_info(args)
    federatedrolebindings = client.federatedrolebindings.list(**page_info)
    utils.print_list(federatedrolebindings, client.federatedrolebindings.columns)